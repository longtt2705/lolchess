      ...
      >
        ...
        <div className="rank-display">
          ...
          <div className="rank-info">
            ...
            <div className="rank-description">Keep climbing the ladder to reach higher ranks!</div>
          </div>
        </div>
        <div className="progress-bar">
          <div className="progress-fill" style={{ width: `${progressToNextRank}%` }} />
        </div>
        <div className="progress-text">
          {user.rating} / {nextRankRating} ({(100 - progressToNextRank).toFixed(0)} rating to next
          rank)
        </div>
      </RankSection>
    </ProfileContainer>
