...
const getStatTooltip = (stat: string): string => {
  const tooltipMap: { [key: string]: string } = {
    ...
    sunder:
      "Sunder (Armor Penetration) - Reduces target's Physical Resistance when calculating damage",
...
const DatabasePage: React.FC = () => {
  ...
  const { champions, basicItems, combinedItems, databaseLoading, databaseError } = useAppSelector(
    (state) => state.game,
  );
    ...
    <PageContainer>
      <ContentWrapper>
        ...
        >
          ...
          <p>
            Browse all champions and items. View stats, abilities, and item effects to plan your
            strategy!
          </p>
        </Header>
          ...
          {activeTab === 'champions' && (
            ...
            >
                  ...
                  >
                    ...
                    <StatsGrid style={{ marginBottom: '16px' }}>
                      <StatItem>
                        <div className="label">
                          <img
                            src={getStatIcon('physicalResistance')}
                            alt="Physical Res"
                            width={16}
                            height={16}
                          />
                      ...
                      <StatItem>
                        <div className="label">
                          <img
                            src={getStatIcon('magicResistance')}
                            alt="Magic Res"
                            width={16}
                            height={16}
                          />
                    ...
                    <StatsGrid style={{ marginBottom: '16px' }}>
                      <StatItem>
                        <div className="label">
                          <img
                            src={getStatIcon('criticalChance')}
                            alt="Crit Chance"
                            width={16}
                            height={16}
                          />
                      ...
                      <StatItem>
                        <div className="label">
                          <img
                            src={getStatIcon('criticalDamage')}
                            alt="Crit Damage"
                            width={16}
                            height={16}
                          />
                      ...
                      <div className="skill-header">
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          >
                            ...
                            {champion.skill.cooldown !== undefined &&
                              champion.skill.cooldown > 0 && (
                                <div
                                  style={{
                                    display: 'flex',
                                    alignItems: 'center',
              ...
              {filteredChampions.length === 0 && (
                <div
                  style={{ textAlign: 'center', padding: '40px', color: 'var(--secondary-text)' }}
                >
                        ...
                        <ItemHeader>
                          ...
                          <div className="item-info">
                            ...
                            {(item as any).cooldown > 0 && (
                              ...
                              >
                                <span style={{ color: 'var(--gold)' }}>
                                  {(item as any).cooldown} turn cooldown
                                </span>
                              </div>
                            )}
                          </div>
                          ...
                          <RecipeDisplay>
                            <div className="recipe-item">
                              {getItemById(item.recipe[0])?.icon ? (
                                ...
                                <span className="item-fallback">
                                  {getItemById(item.recipe[0])?.name || item.recipe[0]}
                                </span>
                              )}
                            </div>
                            ...
                            <div className="recipe-item">
                              {getItemById(item.recipe[1])?.icon ? (
                                ...
                                <span className="item-fallback">
                                  {getItemById(item.recipe[1])?.name || item.recipe[1]}
                                </span>
                              )}
                            </div>
                            <span className="separator">→</span>
