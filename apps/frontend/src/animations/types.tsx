...
export interface SkillAnimationConfig {
  ...
  viktorModules?: {
    ...
    aoeTargets?: Array<{
      // Module 5: Electrical Overload targets
      targetId: string;
      targetPosition: ChessPosition;
    }>;
...
export const ProjectileAnimation = ({
  ...
  return (
    ...
    >
      <Projectile style={color ? { background: color } : {}}>{icon}</Projectile>
    </ProjectileContainer>
  );
};
        ...
        return (
          <motion.div
            ...
            style={{
              ...
              borderRadius: '50%',
              background:
                'radial-gradient(circle, rgba(255, 215, 0, 1) 0%, rgba(200, 155, 60, 0.8) 100%)',
