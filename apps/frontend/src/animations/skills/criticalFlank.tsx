...
import { SkillAnimationConfig, SkillAnimationRenderer, getPixelPosition } from '../types';
...
const DashTrail = styled(motion.div)`
  ...
  background: radial-gradient(
    circle,
    rgba(200, 155, 60, 0.6) 0%,
    rgba(200, 155, 60, 0.2) 50%,
    transparent 100%
  );
  pointer-events: none;
  z-index: 135;
    ...
    <>
      ...
      <DeathAura
        style={{
          ...
          background:
            'radial-gradient(circle, rgba(200, 155, 60, 0.6) 0%, rgba(200, 155, 60, 0.2) 50%, transparent 100%)',
