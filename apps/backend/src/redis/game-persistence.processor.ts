          ...
          .findByIdAndUpdate(
            gameId,
            {
              $set: {
                ...
                hasBoughtItemThisTurn: gameState.hasBoughtItemThisTurn,
                hasUsedSummonerSpellThisTurn: gameState.hasUsedSummonerSpellThisTurn,
                hasPerformedActionThisTurn: gameState.hasPerformedActionThisTurn,
                shopItems: gameState.shopItems,
                shopRefreshRound: gameState.shopRefreshRound,
                rngSeed: gameState.rngSeed,
                rngState: gameState.rngState,
                drakePool: gameState.drakePool,
                drakesKilled: gameState.drakesKilled,
